...
class FullSimpleNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv7 =  ai8x.FusedConv2dBNReLU(128, 128, 3, stride=1, padding=1, bias=bias, batchnorm='Affine', **kwargs)
        ...
        self.conv8 = ai8x.FusedConv2dBNReLU(128, 128, 3, stride=1, padding=1, bias=bias, batchnorm='Affine', **kwargs)

        self.conv9 = ai8x.FusedConv2dBNReLU(128, 128, 3, stride=1, padding=1, bias=bias, batchnorm='Affine', **kwargs)

        self.maxpool3 = ai8x.MaxPool2d(kernel_size=2, stride=2,
                                dilation=1, padding=0)
        
        self.dropout3 = nn.Dropout(0.3)
        self.conv10 = ai8x.FusedConv2dBNReLU(128, 128, 3, stride=1, padding=1, bias=bias, batchnorm='Affine', **kwargs)
        ...
        self.conv11 = ai8x.FusedConv2dBNReLU(128, 128, 1, stride=1, padding=0, bias=bias, batchnorm='Affine', **kwargs)
...
def fullsimplenet(pretrained=False, **kwargs):
    """
    Constructs a NAS v1 model.
    """
    assert not pretrained
    return FullSimpleNet(**kwargs)
